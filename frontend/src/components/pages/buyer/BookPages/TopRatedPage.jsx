...
const TopRatedPage = () => {
  ...
  const totalPages = Math.ceil((topRatedBooks?.totalBooks || 0) / limit);

  useEffect(() => {
    dispatch(getTopRatedBooksAction({ page, limit }));
  }, [dispatch, page]);
  ...
  return (
    ...
    >
      ...
      {topRatedBooks?.totalBooks > limit && (
